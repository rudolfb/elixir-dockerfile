...
RUN npm install -g elm elm-oracle

# Download and Install elm-format
# https://github.com/avh4/elm-format
WORKDIR /tmp
RUN wget --quiet https://github.com/avh4/elm-format/releases/download/0.3.1-alpha/elm-format-0.17-0.3.1-alpha-linux-x64.tgz && \
    tar zxvf elm-format-0.17-0.3.1-alpha-linux-x64.tgz && \
    rm -f elm-format-0.17-0.3.1-alpha-linux-x64.tgz && \
    mv -f elm-format /usr/local/bin/ && \
